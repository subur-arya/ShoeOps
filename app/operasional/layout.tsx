...
export default function OperasionalLayout({ children }: { children: React.ReactNode }) {
  ...
  useEffect(() => {
    async function load() {
      ...
      if (user.role !== 'operasional') { router.push('/owner'); return }
  ...
  return (
    <div className="flex h-screen overflow-hidden">
      <SidebarDark tenant={tenant} userName={userName} onSignOut={signOut} />
